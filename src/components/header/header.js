                    ...
                    {this.props.user == 1 ?
                        <React.Fragment >
                            ...
                            <NavLink to="/revisitas" className="w3-bar-item w3-button w3-hide-small">Revisitas</NavLink>
                                <a className="w3-bar-item w3-button w3-hide-small w3-right" onClick={this.showSettings} ><i class="material-icons">settings</i></a>
                                <a className="w3-bar-item w3-button w3-hide-small w3-right" onClick={this.props.logOutFn}><i className="material-icons">exit_to_app</i></a>
